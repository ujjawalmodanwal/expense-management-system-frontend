...
function Home() {
	...
	const fetchCardsData = async()=>{
		const {data} = await axios.get("https://expense-management-system-backend.onrender.com/api/cards/", {
            headers:{
	...
	const handleAddCardSubmit = async (event) =>{
		...
		try {
			...
			await axios.post('https://expense-management-system-backend.onrender.com/api/cards/create/',{
				newCard
			}, config)
		} catch (error) {
			console.log(error)
	...
	const handleEditCardSubmit = async (event, cardData)=>{
		...
		try {
			...
			await axios.put(`https://expense-management-system-backend.onrender.com/api/cards/${editCardId}`,{
				editedCard
			}, config)
		} catch (error) {
			console.log(error)
	...
	const handleDeleteClick = async (cardDataId)=>{
		...
		try {
			...
			await axios.delete(`https://expense-management-system-backend.onrender.com/api/cards/${cardDataId}`, config)
		} catch (error) {
			console.log(error)
		}
